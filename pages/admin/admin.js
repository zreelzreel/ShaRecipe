    ...
    function renderReviewPanel() {
        ...
        reviewModalContent.querySelectorAll('[data-review-action]').forEach(function(button) {
            button.addEventListener('click', async function() {
                ...
                adminBusy = true;
                const allButtons = reviewModalContent.querySelectorAll('[data-review-action]');
                allButtons.forEach(function(actionButton) {
                    actionButton.disabled = true;
                });
                button.textContent = button.dataset.reviewAction === 'approved'
                    ? 'Approving...'
                    : 'Rejecting...';
