document.addEventListener('DOMContentLoaded', async function() {
    ...
    const defaultSubmitLabel = submitBtn?.textContent || 'Create Account';
    ...
    function setSubmittingState(nextState) {
        ...
        if (submitBtn) {
            ...
            submitBtn.textContent = nextState ? 'Creating Account...' : defaultSubmitLabel;
        }
        usernameInput.disabled = nextState;
        emailInput.disabled = nextState;
