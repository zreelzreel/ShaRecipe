document.addEventListener('DOMContentLoaded', async function() {
    ...
    const defaultSubmitLabel = submitBtn?.textContent || 'Share Recipe';
    ...
    function setSubmittingState(nextState) {
        ...
        if (submitBtn) {
            ...
            submitBtn.textContent = nextState
                ? (editingRecipe ? 'Saving...' : 'Submitting...')
                : defaultSubmitLabel;
        }
        if (choosePhotoBtn) {
            choosePhotoBtn.disabled = nextState;
        }
        if (removePhotoBtn) {
            removePhotoBtn.disabled = nextState || !selectedImage;
        }
    }
